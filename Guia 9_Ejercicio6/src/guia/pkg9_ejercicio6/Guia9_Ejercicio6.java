...
el encuentro.
 */
package guia.pkg9_ejercicio6;

import guia.pkg9_ejercicio6.Entidad.Curso;
...
public class Guia9_Ejercicio6 {
    ...
    public static void main(String[] args) {
        ...
        nueva.crearCurso();
        nueva.calcularGananciaSemanal();
        System.out.println("Ganancia Semanal " + nueva.calcularGananciaSemanal());
    }
}
