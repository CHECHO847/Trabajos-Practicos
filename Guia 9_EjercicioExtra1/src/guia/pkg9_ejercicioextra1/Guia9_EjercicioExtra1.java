 ...
 * 
 */
package guia.pkg9_ejercicioextra1;

import guia.pkg9_ejercicioextra1.Servicio.mesSecretoService;

/**
 *
 * @author G5
 */
public class Guia9_EjercicioExtra1 {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
       mesSecretoService nuevo=new mesSecretoService();
