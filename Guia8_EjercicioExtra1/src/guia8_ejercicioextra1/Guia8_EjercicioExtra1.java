...
*/
package guia8_ejercicioextra1;

import guia8_ejercicioextra1.Entidad.Raices;
import guia8_ejercicioextra1.Servicio.RaicesServicio;
...
public class Guia8_EjercicioExtra1 {
    ...
    public static void main(String[] args) {
        ...
        RaicesServicio  nuevo=new RaicesServicio();
        
        System.out.println("Ingrese el primer valor (a)");
        int num=leer.nextInt();
         System.out.println("Ingrese el primer valor (b)");
        int num1=leer.nextInt();
         System.out.println("Ingrese el primer valor (c)");
        int num2=leer.nextInt();

        Raices raiz=new Raices(num, num1, num2);
