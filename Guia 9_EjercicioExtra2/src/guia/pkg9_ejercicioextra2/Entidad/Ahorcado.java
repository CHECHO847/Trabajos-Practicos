...
llamará en el main.
 */
package guia.pkg9_ejercicioextra2.Entidad;
...
public class Ahorcado {
    ...
    private int letraEncontradas;
    private int jugadas;

    public Ahorcado() {
    }

    public Ahorcado(String[] vector, int jugadas) {
        this.vector = vector;
    ...
    public int getLetraEncontradas() {
        return letraEncontradas;
    }

    public void setLetraEncontradas(int letraEncontradas) {
        this.letraEncontradas = letraEncontradas;
    }
